...
export default function Footer() {
  ...
  return (
    <footer className="relative w-full bg-background py-16 flex justify-center">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-row justify-center lg:justify-start items-center gap-4 mt-4">
            <Link
              ...
              className="bg-[#F5F8FF] dark:bg-[#111827] hover:scale-110 h-12 w-12 flex justify-center items-center rounded-lg"
            >
              <Linkedin />
            </Link>
            <Link
